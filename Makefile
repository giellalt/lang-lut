...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) AUTHORS INSTALL \
	README build-aux/config.guess build-aux/config.sub \
...
ZIP = /usr/bin/zip
abs_builddir = /Users/rueter/main/langs/slh
abs_srcdir = /Users/rueter/main/langs/slh
